...
[Header](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/Shared/Header.razor),
[Sidebar](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/Shared/Sidebar.razor) and
[MainLayout](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/Shared/MainLayout.razor) 
and paste it into 
[/wwwroot/index.html](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/wwwroot/index.html)
...
[PrerenderTasks.cs](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Tests/PrerenderTasks.cs)
with the `prerender` Test category. The only configuration the tasks require is the location of the `ClientDir` WASM Project 
defined in [appsettings.json](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Tests/appsettings.json) 
...
```xml
<PropertyGroup>
    <TestsDir>$(MSBuildProjectDirectory)/../Organizer.Tests</TestsDir>
</PropertyGroup>
...
[<Loading/>](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/Shared/Loading.razor) component
...
[Docs.razor](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/Pages/Docs.razor).
...
[content](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Organizer.Client/wwwroot/content)
directory and uses the same
[/Organizer.Client/MarkdownUtils.cs](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/MarkdownUtils.cs)
implementation [Docs.razor](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/Organizer.Client/Pages/Docs.razor)
