...
##  [/Organizer.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Organizer.Client)
...
## [/Organizer](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Organizer)

The .NET 6 `/Organizer` backend server is required for this App's dynamic functions including the Hello API on the home page
